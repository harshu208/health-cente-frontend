        ...
        <ul className="sidebar-menu">
  ...
  </li>*/}
          {
            ...
            (
              <li className="dropdown">
                <a href="#" className="menu-toggle nav-link has-dropdown"><i
                      data-feather="folder"></i><span>Health Center Admin</span></a>
                  <ul className="dropdown-menu">
                     <li className={isActive('/healthCenter/financial_budget') ? "active": ""}><Link className="nav-link"  to="/healthCenter/financial_budget"><span>Financial Budget</span></Link></li>                                        
                     <li className={isActive('/healthCenter/manage_manufacturers') ? "active": ""}><Link className="nav-link"  to="/healthCenter/manage_manufacturers"><span>Manage Manufacturers</span></Link></li>                    
                     <li className={isActive('/healthCenter/manage_medicines') ? "active": ""}><Link className="nav-link"  to="/healthCenter/manage_medicines"><span>Manage Medicines</span></Link></li>                                         
                     <li className={isActive('/healthCenter/manage_suppliers') ? "active": ""}><Link className="nav-link"  to="/healthCenter/manage_suppliers"><span>Manage Suppliers</span></Link></li>   
                  </ul>
              </li>
            )
          }
